---
title: Performance
description: Optimize Polly resilience pipelines for maximum performance and minimal allocations
icon: gauge-high
---
...
<CodeGroup>
```csharp PredicateBuilder (Slower)
...
```csharp Switch Expression (Faster)

---
title: Telemetry
description: Monitor and observe resilience pipelines with logging, metrics, and distributed tracing
icon: chart-line
---
...
<CardGroup cols={2}>
  <Card title="OnRetry" icon="rotate-right" href="/strategies/retry">
    Retry strategy events
  </Card>
  <Card title="OnFallback" icon="parachute-box" href="/strategies/fallback">
    Fallback strategy events
  </Card>
  <Card title="OnHedging" icon="clone" href="/strategies/hedging">
    Hedging strategy events
  </Card>
  <Card title="OnTimeout" icon="clock" href="/strategies/timeout">
  ...
  <Card title="OnRateLimiterRejected" icon="gauge-high" href="/strategies/rate-limiter">
...
Polly API lets you add extra tags to any resilience event created by resilience strategies. To do this, derive from the `MeteringEnricher` class and add your custom enricher to the `TelemetryOptions.MeteringEnrichers` list.
